...
tcp_low_ports = { scans =   30, rejects = 5, nets =  10, ports =  3 }
tcp_low_decoy = { scans =   0, rejects = 15, nets =  50, ports = 30 }
tcp_low_sweep = { scans =   20, rejects = 0, nets =   1, ports = 4 }
...
default_low_port_scan =
{
    protos = 'all',
    scan_types = 'all',
    --alert_all = true, -- alert on all events over threshold within window if true; else alert on first only
